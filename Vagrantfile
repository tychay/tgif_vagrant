...
Vagrant.configure("2") do |config|
    ...
    config.vm.define host_name do |node|
        node.vm.hostname = host_name + ".dev"
        node.vm.network :private_network, ip: ip_address
        node.hostmanager.aliases = [ "www."+host_name+".dev", "tgif.dev", "www.tgif.dev" ]
    end
    ...
    config.vm.synced_folder "./"+project_name, "/home/vagrant/"+host_name, type: "nfs"
    ...
    if which('ansible-playbook')
        ...
        config.vm.provision :shell, path: "ansible/windows.sh", args: [host_name]
    end
